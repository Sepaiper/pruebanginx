...
<body>
    <div>
        <div id="blockOne">
            ...
            <h1>For</h1>
            <p>El bucle for o ciclo for es una estructura de control en programación en la que se puede indicar de antemano 
                el número mínimo de interacciones.1​ Está disponible en casi todos los lenguajes de programación imperativos.</p>
    ...
    <div id="blockTwo">
        <div id="blockTwoOne">
            <h2>Desarrollo</h2>
            <img src="../../image/for.jpg" alt="imagen 1" height="100%" width="100%">
            <p></p>
